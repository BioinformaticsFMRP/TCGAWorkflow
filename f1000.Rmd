...
TCGAvisualize_meanMethylation(met,
                              groupCol = "disease", width = 3, height = 3,
                              group.legend  = "Groups",
...
plot(analysis.jaspar, ncol=2, top=5, rev=FALSE, main="", bysim=TRUE, cex=0.3)
