...
## ----results='asis', echo=TRUE, message=FALSE,warning=FALSE, include=TRUE----
cancer <- "GBM"
...
## ----results='asis', echo=TRUE, message=FALSE,warning=FALSE,fig.height=10----
...
#  
#  # Get chip-seq data
#  histone.marks <- pbapply::pblapply(names(bpChipEpi_brain), function(x) {ah[[x]]})
