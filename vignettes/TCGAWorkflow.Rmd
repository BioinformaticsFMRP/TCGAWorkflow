...
Due to time and space contraints we downloaded only a subset of the data, for a real analysis please use all data available.
The data used in the examples are available in the package `r Biocpkg("TCGAWorkflowExampleData")`. 
...
```{r results='hide', message=FALSE, warning=TRUE, include=FALSE}
library(TCGAbiolinks)
...
```{r results='hide', eval=FALSE, message=FALSE, warning=TRUE, include=TRUE}
library(TCGAbiolinks)
# Select common CN technology available for GBM and LGG
#############################
## CNV data pre-processing ##
...
```{r results='asis', echo=TRUE, message=FALSE,warning=FALSE,fig.height=10}
...
Listing below shows how to install all the required packages.
