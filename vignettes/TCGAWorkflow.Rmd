...
datatable(LGGmut[1:20,], options = list(scrollX = TRUE, keys = TRUE), rownames = FALSE)
```
...
TCGAvisualize_oncoprint(mut = mut,
                        ...
                        filename = "LGG_GBM_oncoprint.png",
...
dataPrep_LGG <- TCGAanalyze_Preprocessing(object = lgg.exp[1:100,],
                                      cor.cut = 0.6,    
                                      datatype = "raw_count",
                                      filename = "LGG_IlluminaHiSeq_RNASeqV2.png")

dataPrep_GBM <- TCGAanalyze_Preprocessing(object = gbm.exp[1:100,],
                                          cor.cut = 0.6, 
                                          datatype = "raw_count",
...
names.genes.de <- rownames(dataDEGs)[1:50]
...
for (j in direction){
    ...
    pair <- get.pair(mee=mee,
                     ...
                     cores=cores,
                     label= j,
                     permu.size=10, # For significant results use 10000
                     Pe = 0.1) # For significant results use 0.001
