...
# Create object to use un maftools
...
```{r results='asis', echo=FALSE, eval=F, message=FALSE,warning=FALSE}
tagHeatmap(tagMatrixList, xlim=c(-3000, 3000),color = NULL)
```
...
```{r, echo=TRUE, message=FALSE, warnings=FALSE, results='asis',fig.height=8}
