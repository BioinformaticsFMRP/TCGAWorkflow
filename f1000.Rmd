...
met <- TCGAprepare(query.met,dir = ".", save = FALSE,samples = patients)
...
for(cancer in PanCancer){
    ...
    samples <- get(paste0(tolower(cancer),".patients"))
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#   Section 6 Inference of gene regulatory networks
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#---------------------- 6.1 Retrieving known interactions  -------------------
...
#------- 6.2 Using differentially expressed genes from TCGAbiolinks workflow  ----------
...
# cancertype <- "LGG"
### differentially identified genes TCGAbiolinks
...
for (cancertype in c("LGG", "GBM")) {
    ...
    tmp.val <- list(validate(net.aracne, net.biogrid.de), validate(net.mrnet, net.biogrid.de),
       ...
       png(paste0("roc_biogrid_",cancertype,".png"),width = 600, height = 600)
...
to start the motif matching analysis. The result is shown in figure \ref{fig::tfmotif}.
...
plot(analysis.jaspar, ncol=2, top=5, rev=FALSE, main="", bysim=TRUE, cex=1.0)
...
png("chip_heatmap.png", height = 500, width = 600)
...
library(ggthemes)
png("chip-seq.png", height = 500, width = 600)
