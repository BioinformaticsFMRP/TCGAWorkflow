...
#' @docType data
#' @keywords internal
#' @name met.20.samples.GBM.LGG.chr9
#' @format A SumarrizedExperiment with 9861 rows and 20 samples
NULL

#' A DNA methylation matrix and a gene expression matrix for 10 GBM and 10 LGG samples prepared for
#' the creation of an ELMER object.
#' @docType data
#' @keywords internal
#' @name elmer.example
#' @format Gene expression: A matrix with 21022 rows and 20 samples, DNA methylation: A matrix with 8066 rows and 20 samples, 
NULL

#' A gene expression matrix wih 20 LGG samples
#' @docType data
#' @keywords internal
#' @name LGGIlumina_Hiseq
