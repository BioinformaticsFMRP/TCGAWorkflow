...
for(cancer in c("LGG","GBM")){
    ...
    # Chromossome 9  recurrent deleted genes in GBM
    print(head(AmpDel_genes))
}
```
...
dots)](mean_lgg_gbm.png){width="50.00000%"}
...
The Figure below, shows that the samples with lower
