...
Some of pacakges used in this workflow makes use the following Bioconductor packages 
...
gbm.gistic <- getData(gbm.data,type = "GISTIC", CN = "Thresholed")
```
...
We start this analysis by inferring two gene regulatory networks for the GBM data set and one gene set for
the LGG data.
...
```{r results='asis', echo=FALSE, message=FALSE,warning=FALSE}
TCGAsurvival_TFplot(unlist(stringr::str_split(TF[1,"top_5percent"],";"))[1],mee,clinical)
```

```{r results='asis', echo=FALSE, message=FALSE,warning=FALSE}
TCGAsurvival_TFplot(unlist(stringr::str_split(TF[1,"top_5percent"],";"))[2],mee,clinical)
```

```{r results='asis', echo=FALSE, message=FALSE,warning=FALSE}
TCGAsurvival_TFplot(unlist(stringr::str_split(TF[2,"top_5percent"],";"))[1],mee,clinical)
```
